...
Ts=0.004;   %el periodo de muestreo (asegurarse que sea el periodo correcto 
...
%%%Estos son los datos de los otros ejes%%%
x = x.signals.values;
y= y.signals.values;
...
yP=fft(z); %Esta función el la FFT de las señales registradas
