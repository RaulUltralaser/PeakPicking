###########################################################################
## Makefile generated for component 'ArduinoBase'. 
## 
## Makefile     : ArduinoBase.mk
## Generated on : Wed Apr 12 12:46:42 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ArduinoBase.elf
...
SLIB_PATH                 = /home/raul/Documents/MATLAB/R2022b/ArduinoStaticLibrary/ArduinoUno/FasterRuns
SSLIB_PATH                = /home/raul/Documents/MATLAB/R2022b/ArduinoStaticLibrary/ArduinoUno/FasterRuns
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ArduinoBase.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/home/raul/Documents/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/ArduinoBase_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/slave/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -I/home/raul/Documents/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/arduinotarget/include -I/home/raul/Documents/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr
...
DEFINES_STANDARD = -DMODEL=ArduinoBase -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o xcp_ext_mode.o ArduinoBase.o ArduinoBase_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/ArduinoBase_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ArduinoBase_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ArduinoBase_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_arduino_digitalio.o : /home/raul/Documents/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/arduinobase/src/MW_arduino_digitalio.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ArduinoBase.o : $(START_DIR)/ArduinoBase_ert_rtw/ArduinoBase.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ArduinoBase_data.o : $(START_DIR)/ArduinoBase_ert_rtw/ArduinoBase_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/ArduinoBase_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
